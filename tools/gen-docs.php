...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Template',
    nsPrefix: 'Milpa\\Template\\',
    installCommand: 'composer require milpa/template',
    repoUrl: 'https://github.com/getmilpa/template',
    pagesUrl: 'https://getmilpa.github.io/template/',
    heroParagraph: 'Framework-agnostic template rendering (Latte) for the Milpa PHP framework.',
    utmContent: 'template',
);
